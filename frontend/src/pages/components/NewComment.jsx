    ...
    return (
        <div className="flex flex-col bg-tertiary-color rounded-lg mt-5 p-3">
            ...
            <form onSubmit={handleSubmit}>
                <textarea ref={commentRef} onChange={handleInputChange} name="comment" className="bg-secondary-color border border-border-color outline-none p-2 h-40 w-96 rounded-lg mb-3 hover:border-accent-color focus:border-accent-color" placeholder="Write a comment"></textarea>
                <p>
