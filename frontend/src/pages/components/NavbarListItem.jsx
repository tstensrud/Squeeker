            ...
            <Link
                ...
                className={
                    props.selectedIndex === props.index
                        ? "group stroke-navbar-active-link-text flex flex-row mr-3 text-base mt-1 p-1 font-normal bg-navbar-link-active-bg rounded-md text-navbar-active-link-text tracking-wide"
                        : "group flex flex-row mr-3 mt-1 text-base p-1 font-normal tracking-wide text-header-link hover:text-header-link-hover transition-colors duration-200"}>
